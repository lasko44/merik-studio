                            ...
                            <div class="flex items-center justify-between text-sm">
                                <div class="flex items-center gap-4">
                                    <span class="text-gray-500">
                                        Status:
                                        <span class="font-medium text-gray-900 capitalize">{{ campaign.status }}</span>
                                    </span>
                                    <span class="text-gray-500">
                                        Created:
                                        <span class="font-medium text-gray-900">{{ formatDate(campaign.created_at) }}</span>
                                    </span>
                                    <span v-if="campaign.creator" class="text-gray-500">
                                        By:
                                        <span class="font-medium text-gray-900">{{ campaign.creator.name }}</span>
                                    </span>
                                </div>
                                <div class="flex items-center gap-2 text-blue-600">
                                    ...
                                    <span class="text-sm">{{ subscriberCount }} subscribers</span>
                                </div>
                            </div>
                        </div>
